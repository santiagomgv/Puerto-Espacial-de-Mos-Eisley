...
bool CarritoLleno(const TCarrito &carrito);
void IndiceBebida(const TCarrito &carrito, const int &codigo, int &i, bool &encontrada);
void InsertarBebidas(TCarrito &carrito, const TBebida &bebida, bool &correcto);
        ...
        switch(opcion)
            {
                ...
                case 'A':
                    ...
                    cout << "============================" << endl;
                    Leer_bebidas(bebida);
                    InsertarBebidas(carrito,bebida,correcto);
					  if (correcto){
                          cout << "Bebida insertada correctamente." << endl;
					  } else {
					      cout << "Error al insertar la bebida." << endl;
					  }
					  break;
...
void Leer_bebidas(TBebida &bebida){
	cout <<"Codigo de la bebida: "; cin >> bebida.Codigo_Bebida; cin.ignore();
...
void Escribir_bebida(const TBebida &bebida){
    ...
    cout <<"Cliente: " << bebida.Nombre_Cliente << endl;
...
void IndiceBebida(const TCarrito &carrito, const int &codigo, int &i, bool &encontrada){
	...
	{
		if(!carrito[i].espacio_vacio && carrito[i].bebida.Codigo_Bebida == codigo) encontrada = true;
		else ++i;
	}
}
...
void InsertarBebidas(TCarrito &carrito, const TBebida &bebida, bool &correcto){
	int i;
	correcto = !CarritoLleno(carrito);

	if (correcto)
	{
		IndiceBebida(carrito, bebida.Codigo_Bebida, i, correcto);
		correcto=!correcto; // No encontrado
